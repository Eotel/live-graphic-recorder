...
| T07  | A07   | `src/app/container/AppShell.tsx`              | `src/app/view/AppShellRecordingView.tsx`           | AppShell を container/view に責務分割し 200-300 行単位に整理       | T03           |
| T08  | A08   | `src/app/view-model/app-store.ts`             | `src/app/view-model/app-store.test.ts`             | AppShell の状態ソースを app-store へ段階移行し syncSnapshot を廃止 | T01, T02, T03 |
